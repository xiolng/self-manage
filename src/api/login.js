...
export const setLogin = data => Http.post(`${BASE_URL}/system/login/signin`, data) // 登录
...
export const getValidateCode = params => Http.get(`${BASE_URL}/system/login/getValidateCode`, { params }) // 获取用户详情
